(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.SvelteCanvas = {}));
    ...
    function forwardEventsBuilder() {
        ...
        return node => {
            const destructors = events.map(event => listen(node, event, e => bubble(component, e)));
            return {
    ...
    /* src/Canvas.svelte generated by Svelte v3.29.4 */
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function register({ setup, renderer }) {
    ...
    /* src/Layer.svelte generated by Svelte v3.29.4 */
    ...
    function noop$1() { }
    var timer = readable(Date.now() - now, typeof window === 'undefined' ? noop$1 : start);
