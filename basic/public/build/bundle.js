...
var app = (function () {
    ...
    // (65:0) <Canvas    width={window.innerWidth}   height={window.innerHeight}   on:mousemove={handleMouseMove}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(65:0) <Canvas    width={window.innerWidth}   height={window.innerHeight}   on:mousemove={handleMouseMove}>",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function handleMouseMove({ clientX, clientY }) {
    		...
    		if (mousex > window.innerWidth - border - 10) mousex = window.innerWidth - border - 10;
    		if (mousey < border) mousey = border;
    		if (mousey > window.innerHeight - border - 100 - 10) mousey = window.innerHeight - border - 100 - 10;
